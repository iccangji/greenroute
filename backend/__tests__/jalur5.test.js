...
test("Jalur 5", async () => {
    ...
    expect(mutationSpy.mock.calls.length).toBeGreaterThan(1);
    expect(crossoverSpy.mock.calls.length).toBeGreaterThan(1);
    expect(getNeighborSpy.mock.calls.length).toBeGreaterThan(1);
